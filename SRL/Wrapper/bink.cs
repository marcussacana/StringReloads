...
namespace SRL.Wrapper
{
    ...
    public static class BINK
    {
        ...
        public static IntPtr BinkOpenDirectSound(IntPtr param)
        { // don't call directly
            LoadRetail();
        ...
        public static IntPtr BinkOpenWaveOut(IntPtr param)
        { // don't call directly
            LoadRetail();
        ...
        public static IntPtr BinkOpenXAudio(IntPtr param)
        { // don't call directly
            LoadRetail();
        ...
        public static IntPtr BinkOpenMiles(IntPtr param)
        { // don't call directly
            LoadRetail();
        ...
        public static IntPtr BinkOpenSoundManager(IntPtr param)
        { // don't call directly
            LoadRetail();
        ...
        public static IntPtr BinkOpenSDLMixer(IntPtr param)
        { // don't call directly
            LoadRetail();
        ...
        public static IntPtr BinkOpenAX(IntPtr param)
        { // don't call directly
            LoadRetail();
        ...
        public static IntPtr BinkOpenMusyXSound(IntPtr param)
        { // don't call directly
            LoadRetail();
        ...
        public static IntPtr BinkOpenRAD_IOP(IntPtr param)
        { // don't call directly
            LoadRetail();
        ...
        public static IntPtr BinkOpenNDSSound(IntPtr param)
        { // don't call directly
            LoadRetail();
